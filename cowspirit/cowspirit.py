...
class CowSpirit(commands.Cog):
    ...
    def schedule_jobs(self):
        ...
        # Nouver
        self.scheduler.add_job(self.send_nouver_embed, CronTrigger(day_of_week='mon', hour=19, minute=15, timezone="CET"),misfire_grace_time=60)
        ...
        self.scheduler.add_job(self.send_nouver_embed, CronTrigger(day_of_week='wed', hour=12, minute=0, timezone="CET"),misfire_grace_time=60)
        ...
        self.scheduler.add_job(self.send_nouver_embed, CronTrigger(day_of_week='fri', hour=19, minute=0, timezone="CET"),misfire_grace_time=60)
        self.scheduler.add_job(self.send_nouver_embed, CronTrigger(day_of_week='sat', hour=14, minute=0, timezone="CET"),misfire_grace_time=60)
        self.scheduler.add_job(self.send_nouver_embed, CronTrigger(day_of_week='sun', hour=16, minute=0, timezone="CET"),misfire_grace_time=60)

        # Offin
        self.scheduler.add_job(self.send_offin_embed, CronTrigger(day_of_week='mon', hour=14, minute=0, timezone="CET"),misfire_grace_time=60)
        ...
        self.scheduler.add_job(self.send_offin_embed, CronTrigger(day_of_week='sat', hour=12, minute=0, timezone="CET"),misfire_grace_time=60)
    ...
    async def send_garmoth_embed(self):
        ...
        if channel:
            ...
            image_url = "https://raw.githubusercontent.com/XardasDark/Dark-Cogs/main/cowspirit/media/img/garmoth.jpg"
            embed = self.create_embed(title, description, location_value, loot_value, image_url)
    ...
    async def send_karanda_embed(self):
        ...
        if channel:
            ...
            image_url = "https://raw.githubusercontent.com/XardasDark/Dark-Cogs/main/cowspirit/media/img/karanda.jpg"
            embed = self.create_embed(title, description, location_value, loot_value, image_url)
            await channel.send(embed=embed)
    ...
    async def send_kutum_embed(self):
        ...
        if channel:
            ...
            image_url = "https://raw.githubusercontent.com/XardasDark/Dark-Cogs/main/cowspirit/media/img/kutum.jpg"
            embed = self.create_embed(title, description, location_value, loot_value, image_url)
            await channel.send(embed=embed)
    ...
    async def send_nouver_embed(self):
        ...
        if channel:
            ...
            image_url = "https://raw.githubusercontent.com/XardasDark/Dark-Cogs/main/cowspirit/media/img/nouver.jpg"
            embed = self.create_embed(title, description, location_value, loot_value, image_url)
            await channel.send(embed=embed)
    ...
    async def send_offin_embed(self):
        ...
        if channel:
            ...
            image_url = "https://raw.githubusercontent.com/XardasDark/Dark-Cogs/main/cowspirit/media/img/offin.jpg"
            embed = self.create_embed(title, description, location_value, loot_value, image_url)
            await channel.send(embed=embed)
    ...
    async def send_quint_muraka_embed(self):
        ...
        if channel:
            ...
            image_url = "https://raw.githubusercontent.com/XardasDark/Dark-Cogs/main/cowspirit/media/img/quintmuraka.jpg"
            embed = self.create_embed(title, description, location_value, loot_value, image_url)
            await channel.send(embed=embed)
